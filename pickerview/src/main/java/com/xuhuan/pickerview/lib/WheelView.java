...
public class WheelView extends View {
    ...
    private void initData(Context context) {
        ...
        LABEL_OFFSET = com.xuhuan.pickerview.lib.DensityUtil.dip2px(context, LABEL_OFFSET_DIP);
    ...
    protected void notifyChangingListeners(int oldValue, int newValue) {
        for (com.xuhuan.pickerview.lib.OnWheelChangedListener listener : changingListeners) {
     ...
     * @param listener the listener
     */
    public void addScrollingListener(com.xuhuan.pickerview.lib.OnWheelScrollListener listener) {
     ...
     * @param listener the listener
     */
    public void removeScrollingListener(com.xuhuan.pickerview.lib.OnWheelScrollListener listener) {
