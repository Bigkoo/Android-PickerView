...
import com.xuhuan.pickerview.lib.WheelTime;
...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
    ...
    public TimePopupWindow(Context context, Type type) {
        ...
        // -----扩展按钮容器
        btnWrap = (LinearLayout) rootView.findViewById(R.id.btnWrap);
        // ----时间转轮
     ...
     * @param title
     */
    public void addButton(Context context, String title, int index) {
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (timeSelectListener != null) {
                    timeSelectListener.onButtonClick((int) v.getTag());
                }
                dismiss();
            }
        });
        btnWrap.addView(button);
    }
